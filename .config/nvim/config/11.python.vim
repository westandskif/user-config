...
function PythonSpecifics()
  ...
  nnoremap <buffer> <localleader>lmq :lua vim.diagnostic.reset()<CR>:lua try_lint('ruff')<CR>
  nnoremap <buffer> <localleader>lma :lua vim.diagnostic.reset()<CR>:lua try_lint('mypy')<CR>
